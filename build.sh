...
cp ZipBuilder/update_signed.zip ~/Dropbox/couttstech-2.6.38_OC1190_HAVS@925mV_Ginger_CFS_VR_SLQB.zip

cp arch/arm/mach-msm/avs.h.875 arch/arm/mach-msm/avs.h
ARCH=arm make -j2
ZipBuilder/builder.sh
cp ZipBuilder/update_signed.zip ~/Dropbox/couttstech-2.6.38_OC1190_HAVS@875mV_Ginger_CFS_VR_SLQB.zip
...
ARCH=arm make -j2
ZipBuilder/builder.sh
cp ZipBuilder/update_signed.zip ~/Dropbox/couttstech-2.6.38_OC1190_HAVS@850mV_Ginger_CFS_VR_SLQB.zip
...
ARCH=arm make -j2
ZipBuilder/builder.sh
cp ZipBuilder/update_signed.zip ~/Dropbox/couttstech-2.6.38_OC1190_HAVS@825mV_Ginger_CFS_VR_SLQB.zip
...
ARCH=arm make -j2
ZipBuilder/builder.sh
cp ZipBuilder/update_signed.zip ~/Dropbox/couttstech-2.6.38_OC1190_Ginger_CFS_VR_SLQB.zip
